...
<head>
	...
	<link rel="icon" type="image/x-icon" href="../gambar/sistem/logo4.png">

	<title>CarakaDam V Messanger</title>
			...
			<div class="col-12 col-md-3 kotak-kiri d-none d-sm-none d-md-block">
				...
				<div class="kotak-kiri-sidebar">
					...
					<nav class="navbar navbar-expand-lg navbar-light bg-light">
						...
						<div>
							<?php echo $saya['user_nama'] ?>
							(<?php echo $saya['user_nrp'] ?>)
						</div>
				...
				<form action="profil_update.php" method="post" enctype="multipart/form-data">
					...
					<div class="modal-body">
						<div class="form-group row">
							<label class="col-lg-2">NRP</label>
							<div class="col-lg-10">
								<input type="text" name="nrp" class="form-control" value="<?php echo $saya['user_nrp']; ?>" readonly>
							</div>
						</div>
						<div class="form-group row">
